...
public:
    ...
    Vector<T, Alloc>& operator=(Vector<T, Alloc>&& source) noexcept
      { Array<T, Alloc>::operator=(static_cast<Array<T, Alloc>&&>(std::move(source))); return *this; }
    ...
    Vector<T, Alloc>& assign_conforming (const MaskedArray<T> &marray)
      { Array<T, Alloc> (*this).assign_conforming(marray); return *this; }
